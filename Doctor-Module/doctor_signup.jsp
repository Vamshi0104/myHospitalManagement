...
<form action="doctor_logged_auth.jsp" method="post">
<h1 align="center">Doctor_Login</h1><br><br>

<b>Doctor_ID</b><input type="text" name="pn" autofocus placeholder="@CountryCode&Phone_Number" maxlength="24" size="20" required><br>
...
<button type="submit">Login</button><br><br>
     ...
     <br><b>-------OR-------</b><br><br><input type="submit" onClick="window.location.href='doctor_register.jsp'" Value="Create An Account"/>
<script>
function f1() {
