<%-- 
    Document   : user_manage_edit
    Created on : Jun 13, 2019, 11:05:49 AM
    Author     : Vamshi
--%>
...
<body>
    <button class="btn" id="m1" onclick="window.location.href = 'logged_in.jsp';"><i class="fa fa-home"></i>Home &larrhk;</button>
