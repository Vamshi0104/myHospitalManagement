<%-- 
    Document   : admin_recep_edit
    Created on : Jun 11, 2019, 1:50:10 PM
    Author     : Vamshi
--%>
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    <h1 align="center"><u>Update Receptionist Details</u></h1><br>
...
String data="select * from recreg where Phone='"+p+"'";
...
{
String query = "update recreg set FirstName=?, LastName=?,Email=?,Phone=?,Salt_Key=?,Gender=? where Phone='"+d+"'";
...
st.setString(6,f);
st.executeUpdate();
response.sendRedirect("admin_recep_del.jsp");
}
con.close();
}
catch(Exception e)
