<%-- 
    Document   : admin_doc_del
    Created on : Jun 10, 2019, 6:51:59 PM
    Author     : Vamshi
--%>
...
ResultSet rs=st.executeQuery("select * from docreg");
int i=0;
%>
...
<td><a href='admin_doc_delete.jsp?t4=<%=rs.getString("Phone") %>'>Delete</a>
<a href='admin_doc_edit.jsp?t4=<%=rs.getString("Phone") %>'>Edit</a></td>
</tr>
<% c++;%>
<%
i++;
