<%-- 
    Document   : admin_doc_out_del
    Created on : Jun 12, 2019, 6:37:21 PM
    Author     : Vamshi
--%>
...
<td><a href='admin_doc_out_delete.jsp?up=<%=rs.getString("Contact_Doctor") %>'>Delete</a>
<a href='admin_doc_out_edit.jsp?up=<%=rs.getString("Contact_Doctor") %>'>Edit</a></td>
</tr>
<% c++;%>
<%
i++;
