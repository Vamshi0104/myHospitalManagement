<%-- 
    Document   : recep_insert
    Created on : Jun 11, 2019, 10:59:23 AM
    Author     : Vamshi
--%>
...
PreparedStatement ps=con.prepareStatement("insert into recreg values(?,?,?,?,?,?)");
ps.setString(1,f);
ps.setString(2,l);
ps.setString(3,e);
ps.setString(4,p);
...
RequestDispatcher rd=request.getRequestDispatcher("Thankyou1.jsp");
