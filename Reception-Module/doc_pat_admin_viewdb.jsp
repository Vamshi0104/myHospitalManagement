<%-- 
    Document   : doc_pat_admin_viewdb
    Created on : Jun 12, 2019, 5:18:00 PM
    Author     : Vamshi
--%>
...
ResultSet rs=st.executeQuery("select * from doc,ai group by Doctor_FirstName,Patient_Problem order by rand() limit 4");
%>

<h1 align="center">OUT_PATIENTS_DATABASE</h1>
