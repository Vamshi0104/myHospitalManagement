...
<button class="btn" id="m1" onclick="window.location.href = 'admin_sucess.jsp';"><i class="fa fa-home"></i>Home &larrhk;</button>
</head>

<body>


<form action="recep_insert.jsp" method="post">

  <div class="tab" align="centre">
<h1>Only Admin Access!!</h1>
<h1 align="center"><b><u>Receptionist_Register</u></b></h1><br><br>
