<%-- 
    Document   : recep_userform
    Created on : Jun 12, 2019, 7:52:28 AM
    Author     : Vamshi
--%>
<body>
    <a href="recep_sucess.jsp">Back &larrhk;</a>
<form action="recep_manage_insert.jsp" method="post">
    <div>
       ...
       <b>Phone:</b><br><input type="text" name="up" placeholder="@CountryCode+Phone" pattern="[0-9]{2}[0-9]{10,}"autofocus required/><br><br>
